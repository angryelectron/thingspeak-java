...
public class PublicIterator implements Iterator<PublicChannel> {
    ...
    /**
     * Current page of results and an iterator to the list of
 PublicChannel channels it contains.
     */
     ...
     * longitude data.  These empty strings cause NumberFormatExceptions
     * when using the default GSON de-serializer for Double.  This replacement
     ...
     * @param tag Get channels with this tag only, or null to return all channels.     
     */
